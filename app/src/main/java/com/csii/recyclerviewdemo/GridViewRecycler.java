...
public class GridViewRecycler extends AppCompatActivity {
    ...
    private void initData(){
        ...
        Drawable vShapeDrawable = mContext.getResources().getDrawable(R.drawable.shape_vertical_grid_view_divider);

        Drawable hShapeDrawable = mContext.getResources().getDrawable(R.drawable.shape_horizontal_grid_view_divider);


        mRecyclerView.addItemDecoration(new DividerGridItemDecoration(vShapeDrawable,hShapeDrawable));
